...
class OrchestratorBrain:
    ...
    FLEET_REGISTRY = {
        ...
        "editor": {
            ...
            "tools": ["video_generation", "audio_generation", "image_generation", "pdf_generation",
                       "slide_generation", "pinterest", "gdrive"],
            "skills": ["video_editing", "tts", "image_gen", "document_creation", "media_management"],
            "description": "Creates videos, audio, images, PDFs, presentations, manages Pinterest/GDrive.",
        },
        "meta": {
            "name": "Meta Agent",
