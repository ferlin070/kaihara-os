...
class OrchestratorBrain:
    ...
    FLEET_REGISTRY = {
        "kaihara": {
            ...
            "skills": ["orchestration", "delegation", "analysis"],
            "description": "The main AI brain. Coordinates all agents, makes decisions, generates reports.",
            "when_to_use": "Default for all queries. Delegates to specialists when needed.",
        },
        "research": {
            "name": "Research Agent",
            "role": "Data Collection & Analysis",
            "tools": ["web_search", "scrape_website", "search_places", "analyze_data"],
            "skills": ["web_research", "data_analysis", "trend_identification"],
            "description": "Gathers information from the web, analyzes data, produces research reports.",
            "when_to_use": "When user asks to search, find info, research topics, or analyze data.",
        },
        "marketing": {
            "name": "Marketing Agent",
            "role": "Digital Marketing & CRM",
            "tools": ["web_search", "content_generator", "seo_analyzer", "campaign_planner"],
            "skills": ["email_marketing", "social_media", "seo", "copywriting"],
            "description": "Handles marketing campaigns, content creation, SEO.",
            "when_to_use": "When user asks about marketing, SEO, content, campaigns, or social media.",
        },
        "security": {
            "name": "Security Agent",
            "role": "Cybersecurity & Penetration Testing",
            "tools": ["dns_lookup", "reverse_dns", "port_scan", "service_enum", "subdomain_enum",
                       "vuln_scan", "xss_test", "sqli_test", "full_recon", "run_pentest"],
            "skills": ["reconnaissance", "vulnerability_assessment", "penetration_testing"],
            "description": "Performs security scans, vulnerability assessments, and penetration tests.",
            "when_to_use": "When user asks to scan, pentest, check security, or test vulnerabilities.",
        },
        "deploy": {
            "name": "Deploy Agent",
            "role": "Infrastructure & DevOps",
            "tools": ["docker_ps", "docker_compose", "git_status", "git_pull",
                       "systemctl", "nginx_reload", "health_check"],
            "skills": ["docker_management", "git_operations", "deployment"],
            "description": "Manages servers, containers, deployments, and infrastructure.",
            "when_to_use": "When user asks about Docker, Git, servers, deployment, or infrastructure.",
        },
        "editor": {
            "name": "Editor Agent",
            "role": "Content Creation & Media",
            "tools": ["video_trim", "video_concat", "video_export",
                       "image_resize", "generate_thumbnail",
                       "search_stock_image", "download_stock_image",
                       "generate_poster", "generate_banner", "generate_youtube_thumbnail"],
            "skills": ["video_editing", "image_gen", "document_creation", "media_management"],
            "description": "Creates videos, audio, images, PDFs, presentations.",
            "when_to_use": "When user asks to create video, edit image, generate PDF, or make media content.",
        },
        "meta": {
            "name": "Meta Agent",
            "role": "Self-Monitoring & Optimization",
            "tools": ["pattern_detection", "performance_analysis", "suggestion_generation"],
            "skills": ["self_reflection", "pattern_recognition", "optimization"],
            "description": "Monitors system performance, detects patterns, suggests improvements.",
            "when_to_use": "When user asks about system performance, stats, or optimization.",
        },
    }
